...
import (
	log "github.com/southernlabs-io/go-fw/log"
...
func (_m *Middleware) Priority() middleware.MiddlewarePriority {
	...
	var r0 middleware.MiddlewarePriority
	if rf, ok := ret.Get(0).(func() middleware.MiddlewarePriority); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(middleware.MiddlewarePriority)
	}
