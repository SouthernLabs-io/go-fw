...
func (_m *AuthNProvider) Authenticate(ctx *gin.Context) (middleware.Principal, error) {
	...
	var r0 middleware.Principal
	var r1 error
	if rf, ok := ret.Get(0).(func(*gin.Context) (middleware.Principal, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(*gin.Context) middleware.Principal); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(middleware.Principal)
		}
	}
